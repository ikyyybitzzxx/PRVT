...
if (!text)return m.reply('Contoh Penggunaan Command <nomor>\nNote Fitur Ini Hanya Bisa Di Gunakan Untuk Orang Ripper Atau Scamer')
...
let q = `Bug Tag By HyzerDev\n${text}`
let sections = [
      {
        title: 'test',
        rows: [
          { title: 'BugPdf', rowId: `${_p}${command} pdf ${text}` },
          { title: 'BugVn', rowId: `${_p}${command} vn ${text}` },
          { title: 'BugSticker', rowId: `${_p}${command} sticker ${text}` },
          { title: 'BugImg', rowId: `${_p}${command} bugimg ${text}` },
           { title: 'BugVideo', rowId: `${_p}${command} bugvid ${text}` },
          { title: 'BugCrash', rowId: `${_p}${command} bugcrash ${text}` },
          { title: 'BugKontak', rowId: `${_p}${command} bugkontak ${text}` }, 
          { title: 'BugReactPc', rowId: `${_p}${command} reactpc ${text}` },        
          { title: 'BugCatalog', rowId: `${_p}${command} bugcatalog ${text}` }, 
          { title: 'BugTextCrash', rowId: `${_p}${command} bugtextcrash ${text}` },
        ]
      }
    ]
    let listMessage = {
